...
contract GREENWORLD is ERC20, Ownable {
    ...
    constructor() ERC20("Green World", "GRN WRLD", 18) {
 // testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3... smart router 0x10ED43C718714eb63d5aA57B78B54704E256024E
    	...
    	marketingWallet = address(0x420390be63Fcd01fA3e7F691bdA9110c8374Dc38); // set as marketing wallet
    	liquidityWallet = address(0x1AD8E71582904b42E70a1cb0c5bc43D438481d1e); // set as liquidity wallet
        stakingAddress = address(0x815f335eef7285eAd50dcc7F53749A9DB5957AA8); // set as staking wallet / contract
        jumpStartWallet = address(0xB097899ed8BF429531309bd576861265F3F7a8F6); // set as Jump Start wallet
        utilityWallet = address(0xEB1fd00b5E02E8914C582DcE701A4d40eF40D810); // set as utility wallet
